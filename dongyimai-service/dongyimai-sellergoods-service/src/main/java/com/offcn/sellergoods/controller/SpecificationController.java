...
public class SpecificationController {
     ...
     * @return
     */
    @ApiOperation(value = "SpecEntity根据ID修改", notes = "根据ID修改SpecEntity方法详情", tags = {"SpecificationController"})
    @ApiImplicitParam(paramType = "path", name = "id", value = "主键ID", required = true, dataType = "Long")
    @PutMapping(value = "/{id}")
    public Result update(@RequestBody @ApiParam(name = "SpecEntity对象", value = "传入JSON数据", required = false) SpecEntity specEntity, @PathVariable Long id) {
        //设置主键值
    ...
    @PostMapping
    public Result add(@RequestBody @ApiParam(name = "SpecEntity复合对象", value = "传入JSON数据", required = true) SpecEntity specEntity) {
